...
public class ImuDetailVH extends PublisherWidgetViewHolder {
    ...
    protected void bindEntity(BaseEntity entity) {
        ImuEntity imuEntity = (ImuEntity) entity;

        textText.setText(imuEntity.text);
        String degrees = Utils.numberToDegrees(imuEntity.rotation);
    ...
    protected void updateEntity(BaseEntity entity) {
        ...
        imuEntity.text = textText.getText().toString();
        String degrees = rotationSpinner.getSelectedItem().toString();
        imuEntity.rotation = Utils.degreesToNumber(degrees);
    }
